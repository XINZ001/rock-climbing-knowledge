...
rock-climbing/
├── 📋 guides/                           ← 所有指导文件
│   ├── video-tagging-guide.md           → 视频分析标注 bot
...
| 属性 | 说明 |
|------|------|
| **指导文件** | `guides/video-research-guide.md` |
| **任务** | 在 YouTube / Bilibili 搜索攀岩教学视频，匹配到 175 个知识点 |
| **输出** | `video-research/video-research-results.md`（视频条目）+ `coverage-tracker.md`（覆盖率） |
...
| 属性 | 说明 |
|------|------|
| **指导文件** | `guides/video-tagging-guide.md` |
...
| 属性 | 说明 |
|------|------|
| **指导文件** | `guides/article-research-guide.md` |
...
| 属性 | 说明 |
|------|------|
| **指导文件** | `guides/prompt-restructuring-guide.md` |
...
| 属性 | 说明 |
|------|------|
| **指导文件** | `guides/image-generation-guide.md` |
...
| 属性 | 说明 |
|------|------|
| **指导文件** | `guides/image-regeneration-guide.md` |
...
**图片生成 Bot 审核要点**：
- [ ] 风格是否一致（线稿、绿+灰+白底）？
- [ ] 攀岩装备/动作画对了吗（参考 guides/prompt-restructuring-guide.md §4 的错误清单）？
- [ ] 标注文字是否清晰可读？
- [ ] 是否与 Prompt 描述匹配？
...
目前存在两套视频数据格式：
- `video-registry.json`（guides/video-tagging-guide.md 定义的格式）
- `video-research/video-research-results.md`（guides/video-research-guide.md 定义的 markdown 表格格式）
...
### 查看视频搜索进度
→ 读取 `video-research/video-research-results.md` + `archive/influencer-video-master-table.md`
...
### 查看知识体系全貌
→ 读取 `reference/climbing-knowledge-framework.md`
...
*最后更新：2026-03-04*
*项目规模：177 个知识点 × 7 个 Bot（含文件整理 Bot）*
