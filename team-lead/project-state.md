...
|------|---------|------|
| section 数量 | 10 | |
| sub-section 数量 | 50 | +1（Section 03 新增 3.0 攀岩运动原理） |
| knowledge point 数量 | 202 | +25（Section 03 从 37→62） |
| 有插图的 KP | 172 | Section 03 新增 28 个插图 Prompt 待生成 |
| 插图总数 | 289 | |
| 有视频映射的 KP | 138 | |
| 视频总数 | 338 | |
| 文章资源总数（Section 03） | 101 | 原 23→101，覆盖全部 62 个 technique KP |

> **Section 03 Technique 大版本更新 (2026-03-31)**：
> - 新增子板块 3.0 攀岩运动原理（5 KP）
> - 路线阅读从 2→7 个 KP
> - 补充 10 个关键缺失技术 KP（挂膝、休息技术、推拉、对抗力、Figure Four 等）
> - 拆分 3 个 KP 为 8 个精细 KP（crimp→3, COG→3, crack→2）
> - 14 个现有 KP 内容深度扩充
> - 全部 62 个 KP 中文内容均 ≥400 字，平均 957 字/KP
> - 详细计划见 `team-lead/technique-enhancement-plan.md`
