...
├── video-research-results.md           ← ❌ 没有版本控制
│
...
```json
{
  ...
  "trigger": "即将执行 CONTENT-INTEGRATION-PLAN.md 的 Phase 1",
  "files": [
    "section-01-overview.json",
    "section-02-physical.json",
...
```
❌ 无版本控制的重要文件：
├── ARTICLE-RESEARCH-GUIDE.md        ← 你写的指导文件
├── VIDEO-RESEARCH-GUIDE.md
├── IMAGE-GENERATION-GUIDE.md
...
├── video-research-results.md
└── illustration-prompts.md           ← 12 万字的原始 Prompt
```
